...
namespace SS2
{
	public static partial class RTUtil
	{
		...
		{
			if (SS2Core.Instance != null && SS2Core.Instance.Network != null && SS2Core.Instance.Satellites != null)
			{
				if (guid == System.Guid.Empty)
				{
					return "No Target";
				}
				if (SS2Core.Instance.Network.Planets.ContainsKey(guid))
				{
					return SS2Core.Instance.Network.Planets[guid].name;
				}
				...
				ISatellite sat;
				if ((sat = SS2Core.Instance.Network[guid]) != null)
				{
					return sat.Name;
				}
			}
